...
parser.add_argument("month", type=int, help="Month for filtering.")
parser.add_argument("year", type=int, help="Year for filtering.")
...
data = data[(data['exit_time'].dt.year == args.year) & (data['exit_time'].dt.month == args.month)]
...
output_directory = "/home/betti/practice/RH"
month_name = calendar.month_abbr[args.month]
output_filename = os.path.join(output_directory, f"{output_directory}/{month_name}{args.year}_stats.csv"
)
