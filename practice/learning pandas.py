...
#In pandas, "T" is minutes, so we specify the interval is 15T
inputfile = "/home/betti/practice/xnas-itch-20220103.trades.csv"
interval_minutes = '15T'  # 15-minute interval
...
resampled_data = df.resample(interval_minutes).apply(aggregations)
